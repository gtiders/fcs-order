...
from mlfcs.core.geometry import PeriodicGeometry, StructureRelation
from mlfcs.core.real_space import PrimitiveSymmetryOperations
...
def test_every_symmetry_operation_is_an_atom_permutation():
    ...
    operations = SymmetryOperations.from_primitive_operations(
        primitive_operations, relation.index
    )
