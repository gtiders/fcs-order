...
使用公开力常数势生成分温度 MD，并拟合有效 FC2+FC3。
...
[examples/fitting/Ba8Ga16Ge30](https://github.com/gtiders/mlfcs/tree/dev/examples/fitting/Ba8Ga16Ge30) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
