...
将温度相关 MD 数据拟合到 FC4，并记录体数选择和声子谱验证。
...
[examples/fitting/SnSe](https://github.com/gtiders/mlfcs/tree/dev/examples/fitting/SnSe) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
