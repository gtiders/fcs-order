...
极性晶体中 MLFCS 与 phonopy 谐性/SSCHA 结果的对比，并记录已知长程作用限制。
...
[examples/sscha/KCl](https://github.com/gtiders/mlfcs/tree/dev/examples/sscha/KCl) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
