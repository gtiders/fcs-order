...
使用固定剪切整数超胞暴露行列约定、转置、HNF、倒空间标签和 target realization 错误。
...
[examples/fitting/K4As4Pt2](https://github.com/gtiders/mlfcs/tree/dev/examples/fitting/K4As4Pt2) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
