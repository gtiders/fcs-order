...
谐性 FC2 与三声子 FC3 工作流，包括声子谱和下游参考结果。
...
[examples/finite-difference/Si](https://github.com/gtiders/mlfcs/tree/dev/examples/finite-difference/Si) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
