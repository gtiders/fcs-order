...
使用有限差分案例生成的力常数进行 phono3py RTA 交接。
...
[examples/transport/K4As4Pt2](https://github.com/gtiders/mlfcs/tree/dev/examples/transport/K4As4Pt2) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
