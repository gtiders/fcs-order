...
在把流程用于外部 calculator 或更高阶计算前，先阅读[第一个有限差分 FC2 教程](教程/第一个有限差分FC2.md)。

## 典型工作流

| 目标 | 从这里开始 |
|---|---|
| 使用 ASE calculator 计算力常数 | [有限差分工作流](教程/有限差分.md) |
| 将位移结构交给 VASP 或其他外部程序 | [外部计算器教程](教程/外部计算器工作流.md) |
| 从位移或 MD 快照拟合力常数 | [第一次拟合教程](教程/仅力数据的力常数拟合.md) |
| 联合拟合 FC2、FC3 和 FC4 | [联合高阶拟合](教程/FC2、FC3与FC4联合拟合.md) |
| 对 FC2 施加旋转条件 | [旋转约束](教程/旋转约束.md) |
| 计算 FC4 loop 修正 | [SCPH 工作流](教程/SCPH工作流.md) |
| 计算随机有效 FC2 | [SSCHA 工作流](教程/SSCHA工作流.md) |
| 导出到其他软件或超胞 | [互操作](互操作/格式.md) |
...
[能力状态](概览/能力与边界.md)和[路线图](路线图/路线图.md)明确区分稳定、实验、计划、研究与 No-Go 工作。

## 文档地图

### 理论

从[理论](理论/理论.md)开始阅读完整推导和数值约定。

### 核心概念

通过[核心概念](概念/核心概念.md)理解结构、平移、interaction、orbit、参数、基底和 realization。

### 教程

按照[教程学习路线](教程/工作流.md)运行完整、可执行的工作流。

### 任务指南

需要完成具体任务时使用[任务指南](操作指南/选择截断.md)。

### 互操作

向外部软件导出前先阅读[格式与结构约定](互操作/格式.md)。

### 案例

[材料案例](示例/案例.md)连接仓库脚本、参考数据、结果和图像。

### 问答

[问答](问答/问答.md)将常见问题导向权威页面。

### API 参考

[人工维护的 API 参考](参考/API参考.md)记录公共接口契约。

### 路线图

[路线图](路线图/路线图.md)区分稳定、计划、研究与 No-Go 工作。

### 开发者文档

[开发者指南](开发/开发者文档.md)覆盖架构、测试、验证和维护。
