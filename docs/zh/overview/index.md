...
对于昂贵的 calculator，请使用[外部 `sow()`/`reap()` 工作流](../tutorials/external-calculator.md)，
并在结果旁保存 manifest。详见[安装](installation.md)、[第一个 FC2](../tutorials/first-fc2-finite-difference.md)和[结构约定](../how-to/choose-primitive-and-reference.md)。
