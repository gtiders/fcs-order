...
对 ASR、Born–Huang 和 Huang 行为的第二个二维验证案例。
...
[examples/fitting/graphene](https://github.com/gtiders/mlfcs/tree/dev/examples/fitting/graphene) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
