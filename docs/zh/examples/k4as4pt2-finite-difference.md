...
使用显式参考超胞和 PolyMLP 的 FC2/FC3 有限差分。
...
[examples/finite-difference/K4As4Pt2](https://github.com/gtiders/mlfcs/tree/dev/examples/finite-difference/K4As4Pt2) 是本案例的权威目录，包含输入、独立脚本、保留的参考数据和生成产物策略。
