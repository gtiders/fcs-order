...
| 导出到其他软件或超胞 | [互操作](interoperability/index.md) |
...
[能力状态](overview/capabilities.md)和[路线图](roadmap/index.md)明确区分稳定、实验、计划、研究与 No-Go 工作。
...
通过[核心概念](concepts/index.md)理解结构、平移、interaction、orbit、参数、基底和 realization。
...
需要完成具体任务时使用[任务指南](how-to/choose-cutoff.md)。

### 互操作

向外部软件导出前先阅读[格式与结构约定](interoperability/index.md)。

### 案例

[材料案例](examples/index.md)连接仓库脚本、参考数据、结果和图像。

### 问答

[问答](qa/index.md)将常见问题导向权威页面。

### API 参考

[人工维护的 API 参考](reference/index.md)记录公共接口契约。
...
[开发者指南](development/index.md)覆盖架构、测试、验证和维护。
