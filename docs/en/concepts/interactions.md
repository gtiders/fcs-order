---
title: Interactions and clusters
audience:
  - user
status: stable
...
An interaction combines primitive sites and exact integer translations; cutoff and body order determine which interactions enter a model.

## Why it matters

“Interactions and clusters” determines the physical identity carried between calculation stages. Mixing structure labels, periodic translations, numerical arrays, or workflow objects causes mismatches and double counting.
