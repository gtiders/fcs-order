...
An orbit groups interactions related by space-group and index-permutation actions while retaining the tensor transformation of each image.

## Why it matters

“Orbits and images” determines the physical identity carried between calculation stages. Mixing structure labels, periodic translations, numerical arrays, or workflow objects causes mismatches and double counting.
