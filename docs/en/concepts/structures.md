---
title: Structures and reference frames
audience:
  - beginner
status: stable
...
Distinguish the primitive, fixed training reference supercell, target supercell, and snapshots whose atom order must follow the reference.

## Why it matters

“Structures and reference frames” determines the physical identity carried between calculation stages. Mixing structure labels, periodic translations, numerical arrays, or workflow objects causes mismatches and double counting.
