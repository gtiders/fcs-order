...
Distinguish parameter-space constraints, null-space coordinates, and explicit FC2 post-processing projections.

## Why it matters

“Constraints” determines the physical identity carried between calculation stages. Mixing structure labels, periodic translations, numerical arrays, or workflow objects causes mismatches and double counting.
