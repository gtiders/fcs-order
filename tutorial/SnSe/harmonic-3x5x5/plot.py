#!/usr/bin/env python3
"""Plot the 3x5x5 harmonic SnSe FC2 phonon bands."""
...
def main() -> None:
    ...
    for distance, frequencies in zip(band.distances, band.frequencies, strict=True):
        axis.plot(distance, frequencies, color="#d47c5d", linewidth=1.0)
    axis.set_xticks(ticks, labels)
    axis.set_ylabel("Frequency (THz)")
    axis.set_title("SnSe harmonic FC2, 3x5x5 reference")
