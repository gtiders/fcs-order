#!/usr/bin/env python3
"""Plot the 2x4x4 harmonic SnSe FC2 phonon bands."""
...
def main() -> None:
    ...
    for distance, frequencies in zip(band.distances, band.frequencies, strict=True):
        axis.plot(distance, frequencies, color="#4878a8", linewidth=1.0)
    axis.set_xticks(ticks, labels)
    axis.set_ylabel("Frequency (THz)")
    axis.set_title("SnSe harmonic FC2, 2x4x4 reference")
