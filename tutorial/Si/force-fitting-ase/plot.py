"""Plot the Si phonon band from fitted SPOSCAR and phonopy FC2 HDF5."""
...
FORCE_CONSTANTS = Path("force_constants-fit.hdf5")
OUTPUT = Path("fit-phonon-band.png")
...
def main() -> None:
    ...
    axis.set_title("Si phonon band structure from fitted FC2")
    ...
    Path("fit-phonon-band.json").write_text(
        json.dumps(metadata, indent=2) + "\n",
        encoding="utf-8",
    )
    print(f"wrote {OUTPUT} and fit-phonon-band.json")
