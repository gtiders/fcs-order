"""Collect and validate the archived Si FC3 forces."""
...
def main() -> None:
    ...
    for filename, atoms in zip(filenames, generated, strict=True):
        if not _same_structure(atoms, read(CASE / "source/structures" / filename)):
    ...
    print(f"Collected {len(forces)} ordered FC3 force calculations")
